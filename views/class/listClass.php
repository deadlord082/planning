                            ...
                            <div class="fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                                <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                                    <div class="fc-toolbar-chunk">
                                        <h2 class="fc-toolbar-title" id="fc-dom-1">Classes</h2>
                                    </div>
                                    <form action="index.php">
                                        <input name="route" value="addClass" hidden>
                                        <button class="fc-prev-button btn btn-primary" type="submit">Ajoutée une classe</button>
                                    </form>
                                </div>
                                                ...
                                                foreach($classes as $classe){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="max-width: 110px;" >
                                                            <div class="btn-group">
                                                                <form action="index.php">
                                                                    <input name="route" value="showClass" hidden>
                                                                    <input name="id" value="'.$classe['id'].'" hidden>
                                                                    <button class="btn btn-primary" type="submit">Info</button>
                                                                </form>
                                                                <form action="index.php">
                                                                    <input name="route" value="editClass" hidden>
                                                                    <input name="id" value="'.$classe['id'].'" hidden>
                                                                    <button class="btn btn-primary" type="submit">Edit</button>
                                                                </form>
                                                                <form action="index.php">
                                                                    <input name="route" value="delClass" hidden>
                                                                    <input name="id" value="'.$classe['id'].'" hidden>
