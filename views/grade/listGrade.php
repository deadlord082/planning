                            ...
                            <div class="fc fc-media-screen fc-direction-ltr fc-theme-bootstrap">
                                <div class="fc-header-toolbar fc-toolbar fc-toolbar-ltr">
                                    <div class="fc-toolbar-chunk">
                                        <h2 class="fc-toolbar-title" id="fc-dom-1">Niveaux</h2>
                                    </div>
                                    <form action="index.php">
                                        <input name="route" value="addGrade" hidden>
                                        <button class="fc-prev-button btn btn-primary" type="submit">Ajoutée un niveau</button>
                                    </form>
                                </div>
                                                ...
                                                foreach($grades as $grade){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="max-width: 110px;" >
                                                            <div class="btn-group">
                                                                <form action="index.php">
                                                                    <input name="route" value="showGrade" hidden>
                                                                    <input name="id" value="'.$grade['id'].'" hidden>
                                                                    <button class="btn btn-primary" type="submit">Info</button>
                                                                </form>
                                                                <form action="index.php">
                                                                    <input name="route" value="editGrade" hidden>
                                                                    <input name="id" value="'.$grade['id'].'" hidden>
                                                                    <button class="btn btn-primary" type="submit">Edit</button>
                                                                </form>
                                                                <form action="index.php">
                                                                    <input name="route" value="delGrade" hidden>
                                                                    <input name="id" value="'.$grade['id'].'" hidden>
